...
public class TAlmoçoDAO {
    ...
    public void create(Pedido1 p){
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO talmoco (nome, valor, qtd, total)VALUES(?,?,?,?)");
    ...
    public void update(Pedido1 p){
        ...
        try {
            stmt = con.prepareStatement("UPDATE talmoco SET qtd = qtd + ?, total = total + ? WHERE nome=?");            
    ...
    public void update2(Pedido1 p){
        ...
        try {
            stmt = con.prepareStatement("UPDATE talmoco SET nome = ?, valor = ? WHERE nome=?");
            stmt.setString(1, p.getNome());
            stmt.setFloat(2, p.getValor());
            stmt.setString(3, p.getNome());
    ...
    public List<Pedido1> read(){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM talmoco ORDER BY qtd DESC");
    ...
    public List<Pedido1> readForDesc(String desc){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM talmoco WHERE nome LIKE ?");
