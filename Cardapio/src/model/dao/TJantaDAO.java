...
public class TJantaDAO {
    ...
    public void create(Pedido1 p){
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO tjanta (nome, valor, qtd, total)VALUES(?,?,?,?)");
    ...
    public void update(Pedido1 p){
        ...
        try {
            stmt = con.prepareStatement("UPDATE tjanta SET qtd = qtd + ?, total = total + ? WHERE nome=?");            
    ...
    public void update2(Pedido1 p){
        ...
        try {
            stmt = con.prepareStatement("UPDATE tjantar SET nome = ?, valor = ? WHERE nome=?");
            stmt.setString(1, p.getNome());
            stmt.setFloat(2, p.getValor());
            stmt.setString(3, p.getNome());
    ...
    public List<Pedido1> read(){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM tjanta ORDER BY qtd DESC");
    ...
    public List<Pedido1> readForDesc(String desc){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM tjanta WHERE nome LIKE ?");
