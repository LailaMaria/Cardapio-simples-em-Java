...
public class TSobremesaDAO {
    ...
    public void create(Pedido1 p){
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO tsobremesa (nome, valor, qtd, total)VALUES(?,?,?,?)");
    ...
    public List<Pedido1> read(){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM tsobremesa ORDER BY qtd DESC");
    ...
    public void update(Pedido1 p){
        ...
        try {
            stmt = con.prepareStatement("UPDATE tsobremesa SET qtd = qtd + ?, total = total + ? WHERE nome=?");            
    ...
    public void update2(Pedido1 p){
        ...
        try {
            stmt = con.prepareStatement("UPDATE tsobremesa SET nome = ?, valor = ? WHERE nome=?");
            stmt.setString(1, p.getNome());
            stmt.setFloat(2, p.getValor());
            stmt.setString(3, p.getNome());
    ...
    public List<Pedido1> readForDesc(String desc){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM tsobremesa WHERE nome LIKE ?");
