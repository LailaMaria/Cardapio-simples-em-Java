 ...
 * @author laila
 */
public class ConsAlmoço extends javax.swing.JFrame {

    /**
     * Creates new form ConsAlmoço
     */
    ...
    public ConsAlmoço() {
     ...
     public void readTable3(){
        DefaultTableModel modelo = (DefaultTableModel) jTable.getModel();
        modelo.setNumRows(0);
        model.dao.TAlmoçoDAO pdao = new model.dao.TAlmoçoDAO();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsAlmoço.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
