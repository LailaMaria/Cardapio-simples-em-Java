 ...
 * @author laila
 */
public class ConsSobremesa extends javax.swing.JFrame {

    /**
     * Creates new form ConsSobremesa
     */
    public ConsSobremesa() {
        initComponents();
     ...
     public void readTable3(){
        DefaultTableModel modelo = (DefaultTableModel) jTable.getModel();
        modelo.setNumRows(0);
        model.dao.TSobremesaDAO pdao = new model.dao.TSobremesaDAO();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsSobremesa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
