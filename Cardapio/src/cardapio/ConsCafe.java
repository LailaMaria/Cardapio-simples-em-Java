 ...
 * @author laila
 */
public class ConsCafe extends javax.swing.JFrame {

    /**
     * Creates new form ConsCafe
     */
    public ConsCafe() {
        initComponents();
     ...
     public void readTable3(){
        DefaultTableModel modelo = (DefaultTableModel) jTable.getModel();
        modelo.setNumRows(0);
        model.dao.TCafeDAO pdao = new model.dao.TCafeDAO();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsCafe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
