 ...
 * @author laila
 */
public class ConsBebidas extends javax.swing.JFrame {

    /**
     * Creates new form ConsBebidas
     */
    public ConsBebidas() {
        initComponents();
     ...
     public void readTable3(){
        DefaultTableModel modelo = (DefaultTableModel) jTable.getModel();
        modelo.setNumRows(0);
        model.dao.TBebidasDAO pdao = new model.dao.TBebidasDAO();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsBebidas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
